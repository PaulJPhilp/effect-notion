  ...
  "NotionService",
  {
    ...
    effect: Effect.gen(function* () {
      ...
      return {
        ...
        // Use this when the caller already has the schema to avoid an
        // additional retrieveDatabase call.
        ...
        // Full pages variant for repository use, when schema is already known.
        listPagesWithSchema: (
          databaseId: string,
          ...
          getAllPaginatedResults((cursor) =>
            notionClient
              ...
              .pipe(
                Effect.tapError((e) =>
                  Effect.logWarning(
                    `retrieveBlockChildren failed for pageId=${pageId}; cursor=${cursor ?? "<none>"
              ...
              notionClient
                ...
                .pipe(
                  Effect.tapError((e: NotionError) =>
                    Effect.logWarning(
                      `retrieveBlockChildren failed during update for pageId=${pageId}; cursor=${cursor ?? "<none>"
